...
module UserDecorator
  module Retire
    def retire_countdown
      ActiveSupport::Duration.build(UserHibernation.new(self).scheduled_retire_at - Time.current) if hibernated_at?
    end
    ...
    def retire_deadline
      ...
      "#{l UserHibernation.new(self).scheduled_retire_at} (自動退会まであと#{countdown})"
    end
