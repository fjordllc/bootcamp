...
class User < ApplicationRecord
  ...
  MAX_PERCENTAGE = 100
  DEPRESSED_SIZE = 2
  ALL_ALLOWED_TARGETS = %w[adviser all campaign graduate hibernated inactive job_seeking mentor retired student_and_trainee trainee year_end_party admin].freeze
