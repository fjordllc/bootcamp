...
class User < ApplicationRecord
  ...
  with_options if: -> { validation_context.in?(%i[reset_password retirement training_completio]) } do
  ...
  with_options if: -> { !staff? && validation_context.in?(%i[reset_password retirement training_completio]) } do
    validates :job, presence: true
  end

  with_options if: -> { !adviser? && validation_context.in?(%i[reset_password retirement training_completio]) } do
  ...
  with_options if: -> { validation_context.in?(%i[retirement training_completio]) } do
