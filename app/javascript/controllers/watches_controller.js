...
export default class extends Controller {
  ...
  updateEditMode() {
    const isEditMode = this.editModeToggleTarget.checked
    this.#updateDeleteButtonsVisibility(isEditMode)
  ...
  #restoreEditMode() {
    const isEditMode = localStorage.getItem('watches-edit-mode') === 'on'

    this.editModeToggleTarget.checked = isEditMode
    this.#updateDeleteButtonsVisibility(isEditMode)
  }
