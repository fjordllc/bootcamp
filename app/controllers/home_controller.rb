...
class HomeController < ApplicationController
  ...
  def set_required_fields
    @required_fields = RequiredField.new(
      ...
      graduated: current_user.status.graduated?,
      learning_time_frames: current_user.status.graduated? || current_user.learning_time_frames.exists?
    )
  end
  ...
  def display_dashboard
    ...
    @study_streak = StudyStreak.new(current_user.learning_time.reports_with_learning_times, include_wip: false)
  end
