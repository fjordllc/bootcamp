...
module Authentication::LoginHelpers
  ...
  included do
    helper_method :admin_login?,
                  ...
                  :retired_login?,
                  :hibernated_or_training_completed_or_retired_login?
  end
  ...
  def hibernated_or_training_completed_or_retired_login?
    logged_in? && current_user.hibernated_or_training_completed_or_retired?
  end
end
