...
class Events::CalendarsController < ApplicationController
  ...
  def index
    ...
    respond_to do |format|
      format.ics do
        special_calendar = EventsToIcalExporter.export_events(set_export(user))
        ...
        regular_calendar_to_ical = RestClient.get("#{regular_events_calendars_url}.ics", params: { user_id: user_id })
