...
class ReportsController < ApplicationController
  ...
  def show
    ...
    Footprint.find_or_create_by(footprintable: resource, user: current_user) unless @report.user == current_user
    @footprints = Footprint.fetch_for_resource(@report)
    @footprint_total_count = Footprint.count_for_resource(@report)
