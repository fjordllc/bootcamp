...
json.checker_name product.assignment.checker_name
json.checker_avatar product.assignment.checker_avatar
...
json.user do
  ...
  if product.user.training_ends_on
    ...
    json.training_remaining_days product.user.enrollment_period.training_remaining_days
  end
end
