...
ActiveRecord::Schema.define(version: 20170717172137) do
  ...
  create_table "checks", force: :cascade do |t|
    ...
    t.index ["report_id"], name: "index_checks_on_report_id", using: :btree
    t.index ["user_id", "report_id"], name: "index_checks_on_user_id_and_report_id", unique: true, using: :btree
