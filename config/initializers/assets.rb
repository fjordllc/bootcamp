...
# Rails 7: Sprockets を使わない場合はこのファイルは不要です。
# Sprockets を使う場合は sprockets-rails gem を Gemfile に追加してください。
...
# Rails.application.config.assets.precompile += %w( application.css not-logged-in.css lp.css )
#
