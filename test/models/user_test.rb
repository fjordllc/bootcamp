...
class UserTest < ActiveSupport::TestCase
  ...
  test '#elapsed_days' do
    ...
    travel_to Time.zone.local(2020, 1, 1, 0, 0, 0) do
      assert_equal 365, UserEnrollmentPeriod.new(user).elapsed_days
      assert_equal 150, UserEnrollmentPeriod.new(graduated_user).elapsed_days
      assert_not_equal 365, UserEnrollmentPeriod.new(graduated_user).elapsed_days
    end
  end
