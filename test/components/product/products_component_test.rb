...
class Products::ProductsComponentTest < ViewComponent::TestCase
  ...
  def test_any_products_elapsed_reply_warning_days
    ...
    render_inline(Products::ProductsComponent.new(products: products_within_reply_warning_days,
                                                  products_grouped_by_elapsed_days:,
                                                  is_mentor: @is_mentor,
                                                  current_user_id: @current_user.id,
                                                  reply_warning_days: @reply_warning_days))
  ...
  def any_products_almost_passed_reply_warning_days
    ...
    render_inline(Products::ProductsComponent.new(products: products_passed_reply_warning_days,
                                                  products_grouped_by_elapsed_days:,
                                                  is_mentor: @is_mentor,
                                                  current_user_id: @current_user.id,
                                                  reply_warning_days: @reply_warning_days))
