...
class CheckUrlMailerTest < ActionMailer::TestCase
  test "notify_error_url" do
    ...
    practice_error_url = [
      { id: 207936418, url: "http://homepage2.nifty.com/kamurai/CPU.htm" },
      { id: 207936418, url: "http://homepage2.nifty.com/kamurai/MEMORY.htm" },
      { id: 207936418, url: "http://homepage2.nifty.com/kamurai/HDD.htm" }
    ]
